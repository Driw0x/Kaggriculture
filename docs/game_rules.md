# Kaggriculture Game Rules

This document contains the game mechanics and rules used as a reference
during the development of the Kaggriculture agent.

The rules are based on the official Kaggriculture competition documentation.

> This document is maintained for development reference.
> The official competition documentation remains the authoritative source.
